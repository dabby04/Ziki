...
<body>
   ...
   ?>
    <header class="header">
        ...
        <div class="container2" tabindex="1">
    ...
    <div id="posts">
        <nav>
            ...
            <ul>
                <div class="toggle-box"> <li id="home" class="picks"><a href="#">Hot tea</a></li> </div>
                <div class="toggle-box"> <li id="favourites" class="picks"><a href="#">Favourites</a></li> </div>
                 <div class="toggle-box"> <li id="top_comments" class="picks"><a href="#">Top comments</a></li></div>
                 <div class="toggle-box"> <li id="explore" class="picks"><a href="#">Explore</a></li></div>
